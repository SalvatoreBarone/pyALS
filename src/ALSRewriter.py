...
class ALSRewriter:
  ...
  """
  @brief Performs rewriting, i.e. LUT substitution.

  @details
  For each of the approximate configurations resulting from the design-space exploration process, an approximate design
  variant is generated by replacing the specific functions implemented by each of the circuit's LUTs, with their
  respective approximate functions.

  The source-code of approximate variants will be placed in the specified output directory.
  """
  def rewrite(self):
