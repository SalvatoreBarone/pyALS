...
#    parser.add_argument("--debug", action = "store_true", help = "Enable debug output")
    ...
    ys.log("\ttimeout:            " + str(self.__args.timeout) + "\n")
    ys.log("\tnvectors:           " + str(self.__args.nvectors) + "\n")
    ys.log("\tmetric:             " + str(self.__args.metric) + "\n")
    ys.log("\tweights:            " + str(self.__args.weight) + "\n")
    ys.log("\tNSGA-II pop.size:   " + str(self.__args.popsize) + "\n")
    ys.log("\tNSGA-II iterations: " + str(self.__args.iter) + "\n")
    ys.log("\tNSGA-II Pcross:     " + str(self.__args.pcross) + "\n")
    ys.log("\tNSGA-II Ncross:     " + str(self.__args.etac) + "\n")
    ys.log("\tNSGA-II Pmut:       " + str(self.__args.pmut) + "\n")
    ys.log("\tNSGA-II Nmut:       " + str(self.__args.etam) + "\n")
